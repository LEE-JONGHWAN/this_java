...
public class PostTest {
	public static void main(String[] args) throws IOException {
		String propsFilename = 
				args.length > 0 ? args[0] : "post/post.properties";
	 ...
	 * @param userAgent      the user agent to use, or null for the default user
	 *                       agent
	 * @param redirects      the number of redirects to follow manually, or -1 for
	 *                       automatic redirects
